...
window.dom = {
  create: function create(string) {
    //创建复杂的元素时<div><span>123</span></div>，将该html内容写到标签里面就会自动变成元素
    var container = document.createElement("template"); //template标签专门用来容纳任意元素，不会显示在页面中
...
//# sourceMappingURL=/dom.e3ea34e3.map